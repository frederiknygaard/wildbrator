    ...
    (r.prototype = {
      ...
      _appendTooltip: function () {
        ...
        0 === this.container.children(".rs-tooltip").length &&
          ((t = this.tooltip = this.$createElement(
      ...
      _editTooltip: function (t) {
        ...
        s.hasClass("rs-edit") &&
          ...
          (i = this.input = this.$createElement(
            "input.rs-input rs-tooltip-text"
          ).css({ height: s.outerHeight() - e, width: s.outerWidth() - e })),
      ...
      _setContainerClass: function () {
        ...
        "full" == t || "pie" == t || 0 === t.indexOf("custom")
          ...
          : this.container.addClass("rs-" + t.split("-").join(" rs-"));
      },
      _setRadius: function () {
        var t,
          e,
        ...
        "string" == typeof a &&
          ...
          ("+" === a.charAt(0) || "-" === a.charAt(0)
            ...
            : !a.indexOf(",") ||
              (o((i = a.split(","))[0]) &&
                o(i[1]) &&
                ((e = parseFloat(i[0])), (t = parseFloat(i[1])), (r = !1)))),
      ...
      _activeHandleBar: function (t) {
        return this._minRange
          ? this.bar
          : ((t = null != t ? t : this._active), p(this._handleBars()[t - 1]));
      },
          ...
          (p(t.target).hasClass("rs-handle")
            ...
            : ((e = this._getXY(t)),
              ...
              (a = (this.block || this.svgContainer).outerWidth() / 2) -
                ...
                s &&
                s <= a &&
                (0 !== (n = this.control.find(".rs-handle.rs-focus")).length &&
                  t.preventDefault(),
                    ...
                    ? ((o = parseFloat(n.attr("index"))),
                      this._invertRange ||
                        (1 == o && h > this._handle2.angle
                          ? (o = 2)
                          : 2 == o && h < this._handle1.angle && (o = 1)),
                      (this._active = o))
                    : (this._active =
                        this._handle2.angle - h < h - this._handle1.angle
                          ? 2
                          : 1),
        ...
        this._isReadOnly ||
          ...
          0 !=
            ...
            (s =
              ...
              (0 < n ? this.options.step : -this._getMinusStep(i.value))),
      ...
      _moveSliderRange: function (t) {
        ...
        this._showRange &&
          ...
          a
            ? s.push(0)
            : (this._minRange && s.push(0), (n = r), (r = o), (o = n)),
      ...
      _updateARIA: function (t) {
        ...
        this.bar.children().attr({ "aria-valuenow": t }),
          this._rangeSlider
            ? ((e = this._handles()).eq(0).attr({ "aria-valuemin": s }),
            ...
            : this.bar
                .children()
                .attr({ "aria-valuemin": s, "aria-valuemax": a });
      },
      ...
      _validateStartAngle: function () {
        var t = this.options,
          e = t.startAngle;
        return (
          (e = (this.isNumber(e) ? parseFloat(e) : 0) % 360) < 0 && (e += 360),
          (t.startAngle = e)
        );
      },
      ...
      _validateModelValue: function () {
        ...
        this._rangeSlider
          ? ((t = n.split(",")),
            ...
            (s = this._limitValue(s)),
            this._invertRange ||
              ((e = a.min), a.max < e ? i < s && (i = s) : s < i && (s = i)),
      ...
      _updateModelValue: function () {
        ...
        (t = this._rangeSlider
          ? this._handle1.value + "," + this._handle2.value
          : this["_handle" + (this._minRange ? 2 : this._active || 1)].value),
      ...
      return (
        a &&
          ...
          "none" == n
            ? l.push("M " + r, o)
            : "round" == n
            ? l.push("A 1, 1, 0, 0, 1, " + r, o, "A 1, 1, 0, 0, 1, " + h)
            : ("butt" != n && "square" != n) ||
              l.push("L " + r, o, "L " + h, "Z")),
        l.join(" ")
      );
